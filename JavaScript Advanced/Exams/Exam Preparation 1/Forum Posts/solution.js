    ...
    function solve() {
        ...
        const submitButtonEl = document
            ...
            .addEventListener("click", (ev) => {
                if (titleInputEl.value !== "" && categoryInputEl.value !== "" && contentInputEl.value !== "") {
                    addPost(ev, titleInputEl.value, categoryInputEl.value, contentInputEl.value);
                    clearInputFileds();
                }
            });
        ...
        function addPost(ev, titleInputEl, categoryInputEl, contentInputEl) {
            ...
            editBtn.addEventListener("click", (ev) => editPost(ev, titleInputEl, categoryInputEl, contentInputEl));
        }
